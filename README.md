...
This is a cross-agent skill. It focuses on finished poster delivery, quick defaults, film-tone analysis, style-lane routing, and character-reference anchoring.
