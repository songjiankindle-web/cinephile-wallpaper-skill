...
- Before image generation, ask whether the user wants to upload images they want represented in the poster, including but not limited to characters, props, and scenes. In the same turn, ask for optional design requirements such as preferred style, elements, character treatment, tone, composition, or avoid-list. Explain that uploaded images improve character likeness, prop accuracy, scene atmosphere, or other visual specificity; no upload means the skill will decide what appears and how to design it. No design requirement means AI-autonomous design.
