...
- Forbidden style-selection reasoning: do not say the style was chosen because it fits the film's rhythm, genre, tone, story, or content. Say it was drawn by `scripts/draw-style.mjs` and then bridged to the film.
