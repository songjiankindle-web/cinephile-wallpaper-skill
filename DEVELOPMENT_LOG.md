...
- v0.99 方向已确立：迷影桌面核心形态从独立 App 转为跨 agent 的电影壁纸生成 skill/workflow，并强化固定开场、一轮基础设置、影片影调、角色锚点、风格路由、偏好记忆和低 token 海报优先交付。
...
- `docs/迷影桌面 PRD v0.99.md`：当前发布候选主 PRD，覆盖固定开场、一轮基础设置、生图模型路径、统一提示词、影调策略、角色锚点、风格路由、偏好记忆和低 token 交付。
