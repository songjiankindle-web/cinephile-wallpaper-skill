...
- v0.99b 方向已确立：迷影桌面核心形态从独立 App 转为跨 agent 的电影壁纸生成 skill/workflow，并强化固定开场、一轮基础设置、影片影调、角色锚点、风格路由、偏好记忆、用户上传参考图优先和低 token 海报优先交付。
...
- 新增 PRD v0.99a，作为上一版发布候选记录；当前主 PRD 为 `docs/迷影桌面 PRD v0.99b.md`。
...
- `docs/迷影桌面 PRD v0.99b.md`：当前发布候选主 PRD，覆盖固定开场、一轮基础设置、生图模型路径、统一提示词、影调策略、角色锚点、用户上传参考图优先、风格路由、偏好记忆和低 token 交付。
- v0.99a PRD 随 GitHub release/tag 归档，不再保留在当前 v0.99b 包内，避免版本混淆。
